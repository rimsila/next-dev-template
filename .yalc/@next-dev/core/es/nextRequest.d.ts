...
export declare const handlerFunc: (
  configMsg: {
    msg?: string;
    isErr?: boolean;
  } & IRequestOption,
...
declare const commonResponseInterceptor: (
  | ((response: AxiosResponse) => any)
  | (({ response }: { response: AxiosResponse }) => Promise<never>)
)[];
declare const commonResponseWithRefreshTokenInterceptor: (
  | ((response: AxiosResponse) => any)
  | (({ response }: { response: AxiosResponse }) => Promise<unknown>)
)[];
export declare function request<TResult = any>(opt: IRequestOption): Promise<TResult>;
declare function addRequestInterceptor(
  onFulfilled?: (value: any) => any | Promise<any>,
  onRejected?: (error: any) => any,
): number;
declare function ejectRequestInterceptor(interceptorId: number): void;
declare function addResponseInterceptor(
  onFulfilled?: (value: any) => any | Promise<any>,
  onRejected?: (error: any) => any,
): number;
